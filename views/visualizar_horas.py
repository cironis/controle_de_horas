...
seletor_ano = st.selectbox("Selecione o ano", df_horas["ano"].unique(),index=agora_ano)
...
seletor_mes = st.selectbox("Selecione o mês", df_horas["period"].unique(),index=agora_mes)
